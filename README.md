...
The demo GIF at the top is recorded against the LocalStack fleet with
[vhs](https://github.com/charmbracelet/vhs); `scripts/demo.tape` has
the script and regeneration steps.
